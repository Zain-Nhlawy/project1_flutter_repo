...
AppException mapDioException(DioException exception) {
  switch (exception.type) {
    ...
    case DioExceptionType.badCertificate:
      return const ServerException('Could not verify server identity.');
    ...
    case DioExceptionType.badResponse:
      ...
      switch (statusCode) {
        case 400:
          return ServerException(message, errors: errors);
    ...
    default:
      return UnknownException(exception.message ?? 'Unexpected error.');
  }
}
