...
class GroupsContentWidget extends StatelessWidget {
  ...
  const GroupsContentWidget({super.key, required this.demo});
    ...
    return BlocConsumer<DepartmentCubit, DepartmentState>(
      ...
      builder: (context, state) {
        ...
        if (state is DepartmentLoaded) {
          final groups = state.departments
  ...
  void _showDeleteConfirmationDialog(
    ...
    required DepartmentEntity group,
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                departmentCubit.deleteDepartment(group.id!, demoId);
              },
              child: Text(
                l10n.delete,
                style: AppTextStyles.label.copyWith(
...
class _GroupsEmptyState extends StatelessWidget {
  ...
  const _GroupsEmptyState({required this.demo});
