  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<AddDepartmentCubit, AddDepartmentState>(
      buildWhen: (previous, current) =>
          ...
          previous.isGroup != current.isGroup,
      builder: (context, state) {
        ...
        return Column(
          ...
          children: [
            Text(
              state.isGroup ? l10n.groupDescription : l10n.sectionDescription,
            ...
            Container(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  hintText: state.isGroup
                      ? l10n.enterGroupDescription
                      : l10n.enterSectionDescription,
