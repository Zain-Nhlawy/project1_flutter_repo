...
class CourseFaqRepositoryImpl implements CourseFaqRepository {
  ...
  Future<Either<Failure, CourseFaqEntity>> getCourseFaq({
    ...
    return _handle(
      () => remoteDataSource.getCourseFaq(courseId: courseId, faqId: faqId),
    );
  }
  ...
  Future<Either<Failure, List<CourseFaqEntity>>> getCourseFaqs({
    ...
    return _handle(
      () => remoteDataSource.getCourseFaqs(courseId: courseId, cursor: cursor),
    );
  }
  ...
  Future<Either<Failure, void>> deleteCourseFaq({
    ...
    return _handle(
      () => remoteDataSource.deleteCourseFaq(courseId: courseId, faqId: faqId),
    );
  }
