...
class CourseFaqManagementScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: _CourseFaqManagementView(courseId: courseId, courseTitle: courseTitle),
    );
  }
}
...
class _CourseFaqManagementView extends StatefulWidget {
  ...
  @override
  State<_CourseFaqManagementView> createState() => _CourseFaqManagementViewState();
}
...
final confirmed = await showDialog<bool>(
  ...
  builder: (dialogContext) => AlertDialog(
    ...
    content: Text(
      l10n.deleteFaqConfirmation(faq.question),
    ),
    actions: [
      TextButton(
