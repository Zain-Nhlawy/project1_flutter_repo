...
class _CreateLiveStreamScreenState extends State<CreateLiveStreamScreen> {
  ...
  void _submit() {
    if (_formKey.currentState!.validate()) {
      context.read<LiveStreamCubit>().createLiveStream(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(localizations.createLiveStream),
      ...
      body: BlocListener<LiveStreamCubit, LiveStreamState>(
        listener: (context, state) {
          if (state is LiveStreamLoading) {
            ...
            _closeLoadingDialog();
            SnackbarTheme().newSnackBarSuccess(context, localizations.liveStreamCreatedSuccessfully);
