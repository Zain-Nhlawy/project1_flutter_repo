...
class _CreateLessonScreenState extends State<CreateLessonScreen> {
  ...
  final _attachmentsManagerKey =
    GlobalKey<LessonAttachmentsManagerState>();
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
      create: (_) => getIt<AttachmentUploadCubit>(),
    ),
              ...
              builder: (context, uploadState) {
                return BlocBuilder<LessonCubit, LessonState>(
                  builder: (context, lessonState) {
                    final isUploading = uploadState is LessonVideoUploadRequestingUrl ||
                        ...
                        body: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              ...
                              LessonActionButton(
                                loading: isBusy,
                                onPressed: isBusy ? null : () => saveLesson(context),
                              ),
                            ],
                          ),
                        ),
  ...
  Future<void> _handleLessonState(BuildContext context, LessonState state) async {
